...
- Verify the native Git admin guard hook before Git-backed File Station sync takes the NAS lease, and ship/install documentation for the optional bare-repo `pre-receive` guard.
